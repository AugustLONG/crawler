    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(verbose_name='\u7236\u5206\u7c7b', blank=True, to='scraper.Category', null=True)),
            ],
            options={
                'ordering': ('order',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(default=b'H', help_text=b'Data type format for scraped main pages (for JSON use JSONPath instead of XPath)', max_length=1, choices=[(b'H', b'HTML'), (b'X', b'XML'), (b'J', b'JSON')])),
                ('detail_page_content_type', models.CharField(default=b'H', help_text=b'Data type format for detail pages and checker (for JSON use JSONPath instead of XPath)', max_length=1, choices=[(b'H', b'HTML'), (b'X', b'XML'), (b'J', b'JSON')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='\u66f4\u65b0\u65f6\u95f4')),
                ('pipelines', models.ManyToManyField(to='scraper.Pipelines', blank=True)),
                ('scraper', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='scraper.Scraper', null=True)),
                ('scraper_runtime', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='scraper.SchedulerRuntime', null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='scraper.SchedulerRuntime', null=True),
        ),
        migrations.AddField(
            model_name='generalmodel',
            name='website',
