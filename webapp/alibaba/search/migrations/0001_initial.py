    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(verbose_name='\u7236\u5206\u7c7b', blank=True, to='search.Category', null=True)),
            ],
            options={
                'ordering': ('order',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=10, verbose_name='\u5206\u7c7b\u540d\u79f0')),
                ('picture', models.ImageField(upload_to=b'photos', width_field=100, height_field=100, blank=True, null=True, verbose_name='\u56fe\u7247')),
