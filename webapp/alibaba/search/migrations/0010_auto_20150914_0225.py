    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_type', models.CharField(max_length=10, verbose_name='\u8868\u5355\u7c7b\u578b', choices=[(b'select', b'SELECT'), (b'text', b'TEXT'), (b'datetime', b'DATETIME'), (b'textarea', b'TEXTAREA'), (b'date', b'DATE')])),
                ('form_value', models.CharField(help_text='\u5982\u679c\u662f\u8868\u5355\u7c7b\u578b\u662fselect,1:v,2:v2', max_length=250, verbose_name='\u8868\u5355\u503c\u57df', blank=True)),
                ('form_attr', models.CharField(help_text='\u53ef\u4ee5\u662f\u957f\u5ea6\u9650\u5236\uff0c\u6837\u5f0f\u8c03\u6574\u7b49', max_length=250, verbose_name='\u8868\u5355\u5c5e\u6027', blank=True)),
                ...
                ('value_type', models.CharField(default=b'char', max_length=10, verbose_name='\u503c\u7684\u7c7b\u578b', choices=[(b'char', b'char'), (b'email', b'email'), (b'datetime', b'DATETIME'), (b'ip', b'IP'), (b'slug', b'SLUG'), (b'int', b'int'), (b'date', b'DATE')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=200, null=True, verbose_name='\u9875\u9762\u63cf\u8ff0', blank=True)),
                ...
                ('template', models.TextField(help_text='\u53ef\u4ee5\u662f\u6e32\u67d3\u52a8\u6001\u6216\u8005\u9759\u6001\u6a21\u677f', verbose_name='\u6a21\u677f', blank=True)),
                ('url', models.CharField(help_text='\u5982\u679c\u6a21\u677f\u548c\u5730\u5740\u90fd\u5b58\u5728\uff0c\u5219\u5730\u5740\u662f\u72ec\u7acb\u7684\uff0c\u53ef\u4ee5\u76f4\u63a5\u8bbf\u95ee', max_length=200, verbose_name='\u6a21\u677f\u5730\u5740', blank=True)),
        ...
        migrations.AlterModelOptions(
            name='pagemodule',
            options={'get_latest_by': 'created', 'verbose_name': '\u9875\u9762\u6a21\u5757', 'verbose_name_plural': '\u9875\u9762\u6a21\u5757'},
        ),
        migrations.AddField(
