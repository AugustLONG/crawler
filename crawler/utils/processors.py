...
def date(text, loader_context):
    ...
    try:
        ...
        loader_context.get('spider').log('Date could not be parsed ("%s", Format string: "%s")!' % (text, cformat),
                                         logging.ERROR)
        return None
...
def time(text, loader_context):
    ...
    try:
        ...
        loader_context.get('spider').log('Time could not be parsed ("%s", Format string: "%s")!' % (text, cformat),
                                         logging.ERROR)
        return None
...
def duration(text, loader_context):
    ...
    try:
        ...
        loader_context.get('spider').log('Duration could not be parsed ("%s", Format string: "%s")!' % (text, cformat),
                                         logging.ERROR)
        return None
