...
class ctripSpider(BaseSpider):
	...
	start_urls = ['http://hotels.ctrip.com/Domestic/tool/AjaxGetHotelDetailComment.aspx?MasterHotelID=-1&hotel=441507&card=0&property=0&currentPage=0']
	...
	def parse(self, response):
		...
		for flag in xrange(1, num + 1):
			...
			room_type = sel.xpath('//*[@id="hotelCommentList"]/li[' + str(flag) + ']/div[2]/div/span[1]/text()').extract()
			total_overall_rating = sel.xpath('//*[@id="hotelCommentList"]/li[' + str(flag) + ']/div[2]/div/span[3]/text()').extract()
		...
		for key in range(1, 3):
			...
			print link
			yield Request(url="http://hotels.ctrip.com/Domestic/tool/AjaxGetHotelDetailComment.aspx?MasterHotelID=-1&hotel=441507&card=0&property=0&currentPage=1", callback=self.parse)
